...
enum GuidedPuzzles {
    ...
    static let epauletteMates: [GuidedPuzzle] = [
        GuidedPuzzle(name: "Classic Epaulette Mate", description: "King's own pieces trap it on both sides", fen: "7r/6pk/4Q2p/2q1p3/8/7R/5PPP/6K1 w - - 0 1", pgn: "1. Rxh6+ gxh6 2. Qf7#"),
        GuidedPuzzle(name: "Epaulette with Rooks", description: "Rooks on each side block the king", fen: "3rkr2/8/4Q3/8/8/8/8/4K3 w - - 0 1", pgn: "1. Qe7#"),
        GuidedPuzzle(name: "Queen Epaulette", description: "Deliver the epaulette checkmate", fen: "2rqkr2/8/4Q3/8/8/8/8/4K3 w - - 0 1", pgn: "1. Qe7#"),
    ]
}
